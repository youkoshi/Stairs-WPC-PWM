...
HD_PWD='D:/Project/Wireless Charge PWM/PWM/PWM.runs/PWM_PWM_module_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_PWM_module_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PWM_PWM_module_0_0.tcl

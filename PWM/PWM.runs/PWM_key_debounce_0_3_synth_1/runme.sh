...
HD_PWD='D:/Project/Wireless Charge PWM/PWM/PWM.runs/PWM_key_debounce_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_key_debounce_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PWM_key_debounce_0_3.tcl

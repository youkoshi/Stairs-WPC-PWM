...
HD_PWD='D:/Project/Wireless Charge PWM/PWM/PWM.runs/PWM_rst_ps7_0_200M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_rst_ps7_0_200M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PWM_rst_ps7_0_200M_1.tcl
